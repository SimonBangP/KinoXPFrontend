        ...
        for (e = 0; e < f.length; e++) if (u = 0, l = f[e], d = l.getAttribute("name")) {
            ...
            u || s[d].push(l), l.eX = l.eY = 0, function (e, c) {
                e.addEventListener("scroll", e.syn = function () {
                    var l, u, d = s[c], f = e[i + r], h = e[i + o], m = f / (e[i + t] - e[a + t]),
                        p = h / (e[i + n] - e[a + n]), v = 0, E = 0;
                    for (f != e.eX && (v = 1, e.eX = f), h != e.eY && (E = 1, e.eY = h), u = 0; u < d.length; u++) l = d[u], l != e && (v && (f = Math.round(m * (l[i + t] - l[a + t])), l.eX = l[i + r] = f), E && (h = Math.round(p * (l[i + n] - l[a + n])), l.eY = l[i + o] = h))
                }, 0)
            }(l, d)
        }
    };
    ...
    Timetable.prototype = {
        ...
        draw: function (e) {
            ...
            function r(e) {
                ...
                var r = n.firstChild.offsetWidth + "px";
                u(o, r)
            }
            ...
            function f(e, t) {
                ...
                }), c.className = o ? "time-entry " + e.options["class"] : "time-entry", c.style.width = h(e), c.style.left = p(e), l.textContent = e.name, u.textContent = ("0" + e.startDate.getHours()).substr(-2) + ":" + ("0" + e.startDate.getMinutes()).substr(-2) + " - " + ("0" + e.endDate.getHours()).substr(-2) + ":" + ("0" + e.endDate.getMinutes()).substr(-2)
            }

            function h(e) {
                var t = e.startDate, n = e.endDate, o = m(t, n);
                return o / E * 100 + "%"
            }
            ...
            function p(e) {
                var t = v.scope.hourStart, n = e.startDate.getHours() + e.startDate.getMinutes() / 60, o = a(t, n);
                return o / E * 100 + "%"
            }

            var v = this.timetable, E = s(v.scope.hourStart, v.scope.hourEnd), w = document.querySelector(e);
